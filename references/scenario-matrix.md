...
| Feature branch, dirty tree | 0→0b; after plan OK: 2–5 | Standard 收工 (merge/prune still asked separately) |
...
| CI red | pause at 5/6 | **Delegate `gh-fix-ci`** if installed; re-verify then land |
...
| User: 排完 bug 再收工 | 1 → 收工 (0→0b, then 2–5 after plan OK) | |
